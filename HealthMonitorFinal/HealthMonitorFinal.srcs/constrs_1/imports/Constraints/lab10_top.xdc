...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { modeSwitch }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { LED16_R }]; #IO_L11P_T1_SRCC_14 Sch=led16_r   pulseLED
...
##Pmod Header JXADC
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { analog_neg_in }]; #IO_L9N_T1_DQS_AD3N_15 Sch=xa_n[1]
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33 } [get_ports { analog_pos_in }]; #IO_L9P_T1_DQS_AD3P_15 Sch=xa_p[1]
